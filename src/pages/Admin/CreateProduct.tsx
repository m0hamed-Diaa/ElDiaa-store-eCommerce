...
const CreateProduct = () => {
    ...
    const { data: catgeories } = useGetCategoriesQuery({ lang: productLocale });
    ...
    return (
        <div className="p-4">
            <div className="flex items-center justify-between">
                <p className="mb-2">{productLocale === "en" ?
                    isRTL ? `يجب ان تعمل المنتج ب الانجليزى الاول:` : `You MUST Create product with English first:` :
            ...
            <form id="create-admin-product" className="space-y-4 mx-auto max-w-md" onSubmit={handleSubmit(onSubmitProduct)} >
                {/* title */}
                ...
                <Input
                    ...
                    placeholder={isRTL ? "اختر صورة" : "Choose Image"}
                    type="file"
                    accept="
                        image/jpeg,
                        image/png,
...
>
    {thumbnailId &&
        (isRTL
            ? "تم رفع الصورة"
            : "Image Uploaded")}
    {isUploading && (isRTL ? "جار التجميل..." : "Loading...")}
    </div> */}